...
const MIDDLE_CONTRACT_ABI = [
  ...
  { inputs: [], name: 'helperFunction', outputs: [], stateMutability: 'payable', type: 'function' },
  { inputs: [], name: 'helperFunction2', outputs: [], stateMutability: 'payable', type: 'function' },
  {
  ...
  {
    inputs: [{ internalType: 'address', name: '', type: 'address' }],
    name: 'userBuyingMetadata',
    outputs: [{ internalType: 'uint256', name: 'nativeBalance', type: 'uint256' }],
    stateMutability: 'view',
    type: 'function',
  },
