...
function ConnectWallet ({handleSetIsConnecting, isConnecting, handleSetExpiredTime}) {
    ...
    }, [walletAddress, provider, signerAddress, handleSetStatusMeta, isNotExistMeta, handleSetIsConnecting, handleGetStatusMeTamask, loading, userIsPremium, navigate]);
